...
console.log(handleTree(arr, "menuId"));

// let treeArr = [];
// let jishu = 0

// function insetNode(treeArr, pId, node) {
//     console.log(++jishu)
//     for (let i = 0; i < treeArr.length; i++) {
//         if (treeArr[i].menuId == pId) {
//             treeArr[i].children.push(node)
//         } else {
//             if (treeArr[i].children.length > 0) {
//                 insetNode(treeArr[i].children, pId, node)
//             }
//         }
...
// function getTreefilter(pId) {
//     console.log(++jishu)

//     if (pId || pId == 0) {
//         for (let j = 0; j < arr.length; j++) {
//             if (arr[j].parentId == pId) {
//                 insetNode(treeArr, pId, arr[j])
//                 if (arr[j].menuType == 'C' || arr[j].menuType == 'M') {
//                     getTreefilter(arr[j].menuId)
